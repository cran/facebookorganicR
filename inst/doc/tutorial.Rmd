...
## Getting data from Facebook Organic into R
...
## Analyzing our Facebook Organic data 

Now we can analyze our Facebook Organic data. For instance, let's compare the two campaigns we have to see which one performed better the last 100 days. 
